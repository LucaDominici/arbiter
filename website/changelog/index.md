...
Every `## [version]` section in the root `CHANGELOG.md` carries a `**Channel:** <name>` line injected by [`scripts/changeset-channel-tag.mjs`](https://github.com/LucaDominici/arbiter/blob/main/scripts/changeset-channel-tag.mjs) after each version bump. These pages are filtered views of that single source of truth.
