...
// On a task/ or ship/ branch with phase != complete, a completion claim in the
...
function main() {
  ...
  // #1441: anti-replay — the gate-pass must belong to THIS task, not a prior task on the same branch.
  if (gate.task_id !== taskId)
    fail(
