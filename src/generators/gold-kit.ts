...
//
// Red-team scope (BLOCKING): emit a THIN runner that delegates to local `arbiter audit readiness --check`
 ...
 *   scripts/gold-audit.mjs       — thin runner → local `arbiter audit readiness --check`
