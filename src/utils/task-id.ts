 ...
 *
 * Leaf utility — shared by `src/review/dispatch.ts` (re-export), `src/commands/task-state.ts`,
 * and `.claude/hooks/lib.mjs::sanitizeTaskId`. Parity with the hook copy is asserted by
