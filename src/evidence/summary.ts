...
export function validateSummarySchema(
  ...
  if (
    ...
    errors.push(
      `obs_gate must be "PASS" or "FAIL", got: ${String(body["obs_gate"])}`,
    );
  }
