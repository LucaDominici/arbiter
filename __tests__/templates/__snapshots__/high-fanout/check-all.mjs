...
// scripts/check-all.local.mjs is a declared, adopt-safe home for PROJECT-LOCAL
...
// matches only scripts/check-all.mjs and scripts/lib/*.mjs) — `arbiter update
...
// 'never-emitted' skip below) — most projects never create this file. Present
// but malformed (non-array `checks`, or an entry missing name/cmd/a valid
