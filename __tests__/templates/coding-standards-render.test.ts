...
describe('CODING_STANDARDS.md.ejs rendering (#206)', () => {
  describe('TypeScript L2', () => {
    ...
    it('renders without EJS leaks', () => {
      out = renderTemplate(TEMPLATE, cfg({ governanceLevel: 'L2', language: 'typescript' }))
  ...
  describe('Java L2', () => {
    let out: string
    it('renders without EJS leaks', () => {
      out = renderTemplate(TEMPLATE, cfg({ governanceLevel: 'L2', language: 'java' }))
      expect(out).not.toContain('<%')
      expect(out).not.toContain('%>')
    })
  ...
  describe('Kotlin L2', () => {
    it('renders without EJS leaks', () => {
      const out = renderTemplate(TEMPLATE, cfg({ governanceLevel: 'L2', language: 'kotlin' }))
      expect(out).not.toContain('<%')
      expect(out).not.toContain('%>')
    })
  ...
  describe('Python L2', () => {
    it('renders without EJS leaks', () => {
      const out = renderTemplate(TEMPLATE, cfg({ governanceLevel: 'L2', language: 'python' }))
      expect(out).not.toContain('<%')
      expect(out).not.toContain('%>')
    })
  ...
  describe('Go L2', () => {
    it('renders without EJS leaks', () => {
      const out = renderTemplate(TEMPLATE, cfg({ governanceLevel: 'L2', language: 'go' }))
      expect(out).not.toContain('<%')
      expect(out).not.toContain('%>')
    })
  ...
  describe('Rust L2', () => {
    it('renders without EJS leaks', () => {
      const out = renderTemplate(TEMPLATE, cfg({ governanceLevel: 'L2', language: 'rust' }))
      expect(out).not.toContain('<%')
      expect(out).not.toContain('%>')
    })
  ...
  describe('unknown language L2', () => {
    it('renders without EJS leaks', () => {
      const out = renderTemplate(TEMPLATE, cfg({ governanceLevel: 'L2', language: 'unknown' }))
      expect(out).not.toContain('<%')
      expect(out).not.toContain('%>')
    })
  ...
  describe('L3 governance additions', () => {
    it('renders without EJS leaks at L3', () => {
      const out = renderTemplate(TEMPLATE, cfg({ governanceLevel: 'L3', language: 'typescript' }))
      expect(out).not.toContain('<%')
      expect(out).not.toContain('%>')
    })
    ...
    it('does NOT contain L3 section at L2', () => {
      const out = renderTemplate(TEMPLATE, cfg({ governanceLevel: 'L2', language: 'typescript' }))
