...
function renderPlaywright(template: string, overrides: Record<string, unknown> = {}): string {
...
describe('playwright-python templates (#366)', () => {
  ...
  describe('test_smoke.py.ejs', () => {
    it('contains a page.goto call', () => {
      const content = renderPlaywright('e2e/playwright-python/test_smoke.py.ejs')
