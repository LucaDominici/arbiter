...
const ORPHAN_TODO_HOOK = join(
  process.cwd(),
  "src/templates/claude/hooks/check-no-orphan-todo.mjs",
);

const STOP_DANGEROUS_HOOK = join(
  process.cwd(),
  "src/templates/claude/hooks/stop-dangerous.mjs",
);
