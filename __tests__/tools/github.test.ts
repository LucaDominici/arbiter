...
describe('tool output: github', () => {
  ...
  it('generates T1+T2+T3+T4+T5+T5b+T6 CI workflows, PR template, 5 issue templates, compliance-item, issue-state, dependabot, sign-and-attest action, sigstore-retry-sign, AI-PR gate, and codeql workflows (23 files total)', () => {
