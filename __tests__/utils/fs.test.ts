...
describe('resolvedPath', () => {
  it('joins target directory with path parts', () => {
    expect(resolvedPath('/home/user/project', '.claude', 'CLAUDE.md'))
      .toBe(join('/home/user/project', '.claude', 'CLAUDE.md'));
  });

  it('handles single part', () => {
    expect(resolvedPath('/tmp', 'file.txt'))
      .toBe(join('/tmp', 'file.txt'));
  });

  it('handles multiple parts', () => {
    expect(resolvedPath('/root', 'a', 'b', 'c'))
      .toBe(join('/root', 'a', 'b', 'c'));
  });
});
