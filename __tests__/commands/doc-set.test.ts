...
// H1 (gold-doc-capability, Tranche 0) — `arbiter audit docs` is a THIN wrapper over the SSOT engine
// (scripts/check-doc-set.mjs). Before this file (and src/commands/doc-set.ts) existed, the
// generated governed-repo thin-runner (scripts/check-doc-set.mjs.ejs) invokes local `arbiter audit docs`
