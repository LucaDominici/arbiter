...
vi.mock("../../src/wizard/prompts.js", () => ({
  ...
  buildMigrationPlan: vi
    .fn()
    .mockReturnValue({ created: [], updated: [], skipped: [] }),
...
vi.mock("../../src/github/labels.js", () => ({
  provisionLabels: vi
    .fn()
    .mockReturnValue({ created: [], updated: [], skipped: [], errors: [] }),
}));
vi.mock("../../src/github/branch-protection.js", () => ({
  applyBranchProtection: vi
    .fn()
    .mockReturnValue({ applied: false, error: null }),
}));
