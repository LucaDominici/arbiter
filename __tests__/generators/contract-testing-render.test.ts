...
describe('contract-testing render: rest-owned', () => {
  ...
  it("PactVerificationIT.java.ejs: contains 'au.com.dius.pact'", () => {
    const content = renderTemplate('contract-testing/rest-owned/PactVerificationIT.java.ejs', {
      ...baseData,
      contractType: 'rest-owned',
    })
  ...
  it("pact-deps.gradle.ejs: contains 'au.com.dius.pact.provider'", () => {
    const content = renderTemplate('contract-testing/rest-owned/pact-deps.gradle.ejs', {
      ...baseData,
      contractType: 'rest-owned',
    })
  ...
  it("pact_consumer_test.rs.ejs: contains 'pact_consumer'", () => {
    const content = renderTemplate('contract-testing/rest-owned/pact_consumer_test.rs.ejs', {
      ...baseData,
      contractType: 'rest-owned',
    })
  ...
  it("pact_consumer_test.go.ejs: contains 'pact-foundation/pact-go'", () => {
    const content = renderTemplate('contract-testing/rest-owned/pact_consumer_test.go.ejs', {
      ...baseData,
      contractType: 'rest-owned',
    })
  ...
  it("test_pact_consumer.py.ejs: contains 'pact'", () => {
    const content = renderTemplate('contract-testing/rest-owned/test_pact_consumer.py.ejs', {
      ...baseData,
      contractType: 'rest-owned',
    })
    expect(content.includes('pact-python') || content.includes('pact')).toBe(true)
  })
})
...
describe('contract-testing render: rest-public', () => {
  it("openapi-diff.ts.ejs: contains 'openapi-diff'", () => {
    const content = renderTemplate('contract-testing/rest-public/openapi-diff.ts.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
    expect(content).toContain('openapi-diff')
  ...
  it("OpenApiDiffIT.java.ejs: contains 'openapi-diff' or 'openapidiff'", () => {
    const content = renderTemplate('contract-testing/rest-public/OpenApiDiffIT.java.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
    expect(content.includes('openapi-diff') || content.includes('openapidiff')).toBe(true)
  })

  it("openapi_diff_test.rs.ejs: contains 'openapi-diff'", () => {
    const content = renderTemplate('contract-testing/rest-public/openapi_diff_test.rs.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
    expect(content).toContain('openapi-diff')
  ...
  it("openapi_diff_test.go.ejs: contains 'openapi-diff'", () => {
    const content = renderTemplate('contract-testing/rest-public/openapi_diff_test.go.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
    expect(content).toContain('openapi-diff')
  ...
  it("test_openapi_diff.py.ejs: contains 'openapi-diff'", () => {
    const content = renderTemplate('contract-testing/rest-public/test_openapi_diff.py.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
    expect(content).toContain('openapi-diff')
...
describe('contract-testing render: rest-public exporters', () => {
  it('export-openapi.mjs.ejs: renders and writes openapi-current.yaml', () => {
    const content = renderTemplate('contract-testing/rest-public/export-openapi.mjs.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
  ...
  it('export-openapi-java.gradle.ejs: renders and targets openapi-current.yaml', () => {
    const content = renderTemplate('contract-testing/rest-public/export-openapi-java.gradle.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
    expect(content).toContain('openapi-current.yaml')
  ...
  it('export_openapi.py.ejs: renders FastAPI exporter writing openapi-current.yaml', () => {
    const content = renderTemplate('contract-testing/rest-public/export_openapi.py.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
    expect(content).toContain('openapi-current.yaml')
  ...
  it('export_openapi.go.ejs: renders Go exporter writing openapi-current.yaml', () => {
    const content = renderTemplate('contract-testing/rest-public/export_openapi.go.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
    expect(content).toContain('openapi-current.yaml')
  ...
  it('export_openapi.rs.ejs: renders Rust exporter writing openapi-current.yaml', () => {
    const content = renderTemplate('contract-testing/rest-public/export_openapi.rs.ejs', {
      ...baseData,
      contractType: 'rest-public',
    })
    expect(content).toContain('openapi-current.yaml')
...
describe('contract-testing render: graphql', () => {
  it("graphql-inspector.test.ts.ejs: contains 'graphql-inspector'", () => {
    const content = renderTemplate('contract-testing/graphql/graphql-inspector.test.ts.ejs', {
      ...baseData,
      contractType: 'graphql',
    })
    expect(content).toContain('graphql-inspector')
  ...
  it('GraphqlSchemaTest.java.ejs: uses @graphql-inspector/cli via ProcessBuilder (F4/INV parity)', () => {
    const content = renderTemplate('contract-testing/graphql/GraphqlSchemaTest.java.ejs', {
      ...baseData,
      contractType: 'graphql',
    })
  ...
  it("graphql_schema_test.rs.ejs: contains 'graphql-inspector'", () => {
    const content = renderTemplate('contract-testing/graphql/graphql_schema_test.rs.ejs', {
      ...baseData,
      contractType: 'graphql',
    })
    expect(content).toContain('graphql-inspector')
  ...
  it("graphql_schema_test.go.ejs: contains 'graphql-inspector'", () => {
    const content = renderTemplate('contract-testing/graphql/graphql_schema_test.go.ejs', {
      ...baseData,
      contractType: 'graphql',
    })
    expect(content).toContain('graphql-inspector')
  ...
  it("test_graphql_schema.py.ejs: contains 'graphql-inspector'", () => {
    const content = renderTemplate('contract-testing/graphql/test_graphql_schema.py.ejs', {
      ...baseData,
      contractType: 'graphql',
    })
    expect(content).toContain('graphql-inspector')
...
describe('contract-testing render: grpc', () => {
  ...
  it("buf-breaking.yml.ejs: contains 'FILE'", () => {
    const content = renderTemplate('contract-testing/grpc/buf-breaking.yml.ejs', {
      ...baseData,
      contractType: 'grpc',
    })
  ...
  it("grpc-contract.test.ts.ejs: contains 'buf'", () => {
    const content = renderTemplate('contract-testing/grpc/grpc-contract.test.ts.ejs', {
      ...baseData,
      contractType: 'grpc',
    })
    expect(content).toContain('buf')
  ...
  it("GrpcContractTest.java.ejs: contains 'buf'", () => {
    const content = renderTemplate('contract-testing/grpc/GrpcContractTest.java.ejs', {
      ...baseData,
      contractType: 'grpc',
    })
    expect(content).toContain('buf')
  ...
  it("grpc_contract_test.rs.ejs: contains 'buf'", () => {
    const content = renderTemplate('contract-testing/grpc/grpc_contract_test.rs.ejs', {
      ...baseData,
      contractType: 'grpc',
    })
    expect(content).toContain('buf')
  ...
  it("grpc_contract_test.go.ejs: contains 'buf'", () => {
    const content = renderTemplate('contract-testing/grpc/grpc_contract_test.go.ejs', {
      ...baseData,
      contractType: 'grpc',
    })
    expect(content).toContain('buf')
  ...
  it("test_grpc_contract.py.ejs: contains 'buf'", () => {
    const content = renderTemplate('contract-testing/grpc/test_grpc_contract.py.ejs', {
      ...baseData,
      contractType: 'grpc',
    })
    expect(content).toContain('buf')
...
describe('contract-testing render: message-queue', () => {
  it('schema-registry-check.ts.ejs: calls testCompatibility (F3/INV-41)', () => {
    const content = renderTemplate('contract-testing/message-queue/schema-registry-check.ts.ejs', {
      ...baseData,
      contractType: 'message-queue',
    })
  ...
  it('schema_registry_test.rs.ejs: calls post_schema_compatibility (F3/INV-41)', () => {
    const content = renderTemplate('contract-testing/message-queue/schema_registry_test.rs.ejs', {
      ...baseData,
      contractType: 'message-queue',
    })
  ...
  it('schema_registry_test.go.ejs: POSTs to /compatibility/ endpoint (F3/INV-41)', () => {
    const content = renderTemplate('contract-testing/message-queue/schema_registry_test.go.ejs', {
      ...baseData,
      contractType: 'message-queue',
    })
    expect(content).toContain('/compatibility/')
  ...
  it('test_schema_registry.py.ejs: calls test_compatibility (F3/INV-41)', () => {
    const content = renderTemplate('contract-testing/message-queue/test_schema_registry.py.ejs', {
      ...baseData,
      contractType: 'message-queue',
    })
