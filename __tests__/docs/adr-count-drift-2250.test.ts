...
// verified actual count (docs/internal/ADR/) is 113 files (ADR-001..114, gap at ADR-103,
// confirmed by DECISIONS.md's generated 113-row digest). Same "hand-copied count drifts"
