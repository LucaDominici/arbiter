...
if [ -n "$dispatch_file" ] && [ -f "$dispatch_file" ] && node scripts/check-cross-model-review.mjs --require-fulfilled --record-panel "$candidate_review_agents_json" --record-count "1" >/dev/null 2>&1; then
