...
// pre-existing fixture value on an untouched line (a fake email planted for a
// test, a fixture credit-card number) must not block an unrelated edit
// elsewhere in the same file. Untracked files and git errors fail OPEN to the
