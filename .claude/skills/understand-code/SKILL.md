...
## Step 3: Invariant Mapping

Check which invariants apply. The registry is at `GLOBAL_INVARIANTS.md`.

For each applicable INV:

- Is it currently enforced in the code you read?
- Are there gaps? (Note them — do NOT fix during this skill)
