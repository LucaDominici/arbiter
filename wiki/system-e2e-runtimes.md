...
> Source: [docs/SYSTEM/E2E-RUNTIMES.md](../docs/SYSTEM/E2E-RUNTIMES.md)
...
| ---------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------- |
| `java-library-gradle/` has no `gradle/verification-metadata.xml` | Yes      | Minimal-fixture posture: mavenCentral artifacts flow without hash verification. Real Ja |

_[content truncated — see source for full text]_

## See Also

- [[reference-ci-tier-workflows]] — related
