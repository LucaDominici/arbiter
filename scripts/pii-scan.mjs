...
import { isAllowedByEntry } from './lib/suppressions-shared.mjs'
...
// verbatim with .claude/hooks/check-no-pii.mjs — see isAllowedByEntry's
// docstring for the specificity-floor semantics.
