...
const PATH_ALLOWLIST = new Set([
  ...
  // INVARIANT-CATALOG.md narrates the T2 cut in the same sentence
  // ("commands/conformance.ts deleted"); website/governance/INVARIANT-CATALOG.md
  // is its byte-for-byte mirror.
  'docs/internal/SYSTEM/INVARIANT-CATALOG.md:commands/conformance.ts',
  'website/governance/INVARIANT-CATALOG.md:commands/conformance.ts',
  ...
  'website/governance/INVARIANT-CATALOG.md:scripts/check-arbiter-contract.mjs',
  'docs/internal/SYSTEM/INVARIANT-CATALOG.md:scripts/check-arbiter-contract.mjs',
  ...
  'website/governance/INVARIANT-CATALOG.md:docs/SOURCES.md',
  'docs/internal/SYSTEM/INVARIANT-CATALOG.md:docs/SOURCES.md',
  ...
  'website/governance/INVARIANT-CATALOG.md:docs/USE_CASES.md',
  'docs/internal/SYSTEM/INVARIANT-CATALOG.md:docs/USE_CASES.md',
  'website/governance/INVARIANT-CATALOG.md:docs/MILESTONES.md',
  'docs/internal/SYSTEM/INVARIANT-CATALOG.md:docs/MILESTONES.md',
