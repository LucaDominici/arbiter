...
// arbiter — workflow documentation sync checker (INV-89)
// Validates that all workflow files are documented in docs/REFERENCE or docs/architecture.
// Exits 0 when all workflows are documented; exits 1 when undocumented workflows found.
// Part of the anti-drift validator family (W6).
//
// Usage: node scripts/check-workflow-docs-sync.mjs [--dir <path>] [--help]
...
if (args.includes('--help') || args.includes('-h')) {
  process.stdout.write(
    [
      ...
      'Exits 0 when all workflows are documented; exits 1 when undocumented found.',
      '',
      'Options:',
...
// Workflows that are exempt from documentation requirement (infrastructure/internal)
...
// Gather all doc content for reference
