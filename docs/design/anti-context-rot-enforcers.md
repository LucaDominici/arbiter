...
| **Invariant numbering**                         | Highest existing invariant is INV-136 (`src/invariants/catalog.ts`). New hard-tier enforcers claim INV-138+ (catalog + `GLOBAL_INVARIANTS.md`, parity-gated by `check-global-invariants-parity.mjs`); advisory-tier enforcers do NOT burn an INV until promoted.                                                                                                                                                                                                                                                                                                                                  |
