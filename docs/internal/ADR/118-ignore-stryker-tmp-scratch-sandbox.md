---
title: 'ADR-118: Ignore .stryker-tmp/ — Stryker Scratch Sandbox Is Never Formatted Content'
doc_version: '1.0.0'
status: active
...
# ADR-118: Ignore .stryker-tmp/ — Stryker Scratch Sandbox Is Never Formatted Content
