...
| `skill-forced-eval.mjs`         | Stop               | \*           | read, stderr-block, write    | `.claude/.task/status.json`, transcript, `scripts/check-tdd-evidence.mjs`, session marker                              | SAFE (#2383/#2861; exit 2 on edit without phase Skill(tdd) or green/refactor receipt)             |
