...
no executable PR command is present. Exact or embedded `gh pr create` / `gh pr ready` commands,
including executable command substitutions, remain fail-closed; single-quoted literals do not.
