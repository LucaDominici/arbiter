...
| - In FE projects (archetype frontend-spa or lanes:[frontend] | AGENTS.md:420                     | medium   |
| - In FE projects, domain and store files MUST NOT import or  | AGENTS.md:424                     | medium   |
| - In FE projects, state store files MUST NOT contain async f | AGENTS.md:428                     | medium   |
| - `node scripts/capture-debt-baseline.mjs --update` — Tighte | AGENTS.md:549                     | medium   |
