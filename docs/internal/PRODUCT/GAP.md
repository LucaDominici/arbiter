...
| - In FE projects (archetype frontend-spa or lanes:[frontend] | AGENTS.md:435                     | medium   |
| - In FE projects, domain and store files MUST NOT import or  | AGENTS.md:439                     | medium   |
| - In FE projects, state store files MUST NOT contain async f | AGENTS.md:443                     | medium   |
| - `node scripts/capture-debt-baseline.mjs --update` — Tighte | AGENTS.md:564                     | medium   |
