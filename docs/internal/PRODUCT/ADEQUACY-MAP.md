...
gstack, Hermes, Augment, Tessl, Matt Pocock's `wayfinder` skill, and the Agentsway methodology (arXiv 2510.23664).
...
| Portability across agents               | Spec Kit 30+ agents; Superpowers 6 harnesses; Agent Skills open standard                                                                                                                                   | Claude + Codex (Codex bridge only fixed on 2026-08-29); every other tool rejected at init, and the five unreachable generators retired outright (ADR-119); skills are Agent-Skills-shaped already                  | **GAP** — decide the second-tier harness list (M-D)                                                            |
| Planning beyond one session             | Matt Pocock `wayfinder`: map issue (destination / decisions-so-far / not-yet-specified fog / out-of-scope) + typed decision tickets, frontier via native blocking, one decision per session, planning only | `brainstorming` and `epic-decompose` cover the ends; no decision tickets, no map index, blocking is prose, epic-decompose pre-slices fog | **GAP** — #2425                                                                                                |
...
| M-D Spec-driven parity (due 2026-10-30)    | #2421 harness portability · #2422 KPI nightly · #2423 brownfield delta contract · #2425 wayfinding                                                                                                          | #2368 epic · #2359 spec artifact · #2363 clarification loop · #2364 requirements rubric · #2365 spec↔plan check · #2366 convergence · #2039 doctor methodology view |
