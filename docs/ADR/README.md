...
| 016 | [RestAssured + mutation testing](016-restassured-mutation-testing.md)   | Proposed | 2026-04-08 | 3-layer Java enforcement: no MockMvc (hook + ArchUnit + policy), mandatory pitest at L2 gate (#61)                |
