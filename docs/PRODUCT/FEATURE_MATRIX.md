...
| REQ-014    | Project configuration surface                          | N69,N70,N71,N72                 | L1    | Partial | src/wizard/types.ts                                                 |                                                                                           |                                                                                 |           | arbiter.json schema; strictnessTier now live (noUncheckedIndexedAccess TS + pedantic Rust); databaseEngine still dead (GAP #1058) |
