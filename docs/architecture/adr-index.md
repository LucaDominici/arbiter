...
plus a **gap register** flagging architecturally-significant decisions that have *no* ADR. This is a
...
| 035 | Pluggable decomposition backend (github / markdown) — *consumer command since pruned, see §11.4* | Accepted |
...
| 046 | Stack adapter model — *self-scaffold since retired (#1837)* | Accepted |
...
*(There is no ADR-103 — see the gap register below.)*
