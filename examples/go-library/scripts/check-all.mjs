...
console.log('');
console.log(`=== go-library Quality Gate: ${level} ===`);
console.log('');
...
runCheck('race detector (full)', 'go', ['test', '-race', './...']);
