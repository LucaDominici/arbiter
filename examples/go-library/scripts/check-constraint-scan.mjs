...
Options:
  --docs=<a,b,c>   Comma-separated governance docs (default: AGENTS.md,${INVARIANT_CATALOG_DOC},docs/SYSTEM/CANON.md,.claude/CLAUDE.md)
...
function parseArgs(argv) {
  ...
  return {
    ...
    docs: docs
      ...
      : ['AGENTS.md', INVARIANT_CATALOG_DOC, 'docs/SYSTEM/CANON.md', '.claude/CLAUDE.md'],
    src: src || 'src',
...
const NEGATED_PASSIVE = /\b(?:nothing|not|no longer)\s+(?:is\s+|are\s+)?(?:forbidden|prohibited|disallowed)\b/i
