...
console.log('');
console.log(`=== python-library Quality Gate: ${level} ===`);
console.log('');
...
runCheck('doctest + strict markers', 'pytest', ['--doctest-modules', '--strict-markers']);
