...
- **INV-03:** Module boundaries enforced — no circular imports, layered architecture respected
- **INV-04:** Type annotations required on all public function signatures
- **INV-05:** Cyclomatic complexity ≤ 15 (`ruff C901` rule)
...
- Use `pytest` for testing with fixtures over setUp/tearDown
...
```
L1 (delivery candidate): ruff check .
                          ruff format --check .
                          pytest
